...
- **[User-Entscheidung: umsetzen]** Icon-Platzhalter an den Energie-Füllbalken (Blatt/Tropfen/Kristall) durch echtes Artwork ersetzen.
- **[User-Entscheidung: umsetzen]** Reward-Preview am Feen-Energie-Füllbalken ausarbeiten (siehe Eintrag unten in "Niedrig").
- **[User-Entscheidung: umsetzen]** Streak-Freeze für `DailyRewardManager` umsetzen (siehe Eintrag unten in "Mittel").
