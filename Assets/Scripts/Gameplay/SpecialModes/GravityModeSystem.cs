...
public void Activate()
{
    ...
    private IEnumerator Co_GravityMode(int maxSpawnCount = -1, bool diamondBonusActive = false)
    {
        ...
        // würde die Phase bei fehlendem gravityDiamondPrefab um diamondBonusCount längere Normal-
        // Elemente spawnen (bonusTickIndices bliebe leer), obwohl PhaseManager den Bonus schon
        // verbraucht hat.
        bool spawnBonusDiamonds = maxSpawnCount > 0 && diamondBonusActive && gravityDiamondPrefab != null;
