...
Shader "Sprite Shaders Ultimate/2D Lit URP SSU"
{
	Properties
	{
		...
		[Toggle] _WindAxisHorizontal( "Wind: Bend Horizontally (X) instead of Vertically (Y)", Float ) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_39_0_g11666 = ( lerp( temp_output_1_0_g11666.y, temp_output_1_0_g11666.x, _WindAxisHorizontal ) + _WindFlip );
				float3 appendResult43_g11666 = (float3( lerp( 0.5, -_WindFlip, _WindAxisHorizontal ) , lerp( -_WindFlip, 0.5, _WindAxisHorizontal ) , 0.0));
				float windSquishAmount_g11666 = ( _WindSquishFactor * min( ( ( _WindSquishWindFactor * abs( lerpResult86_g11666 ) ) + abs( _WindRotation ) ) , _WindMaxRotation ) * temp_output_39_0_g11666 );
				float2 appendResult27_g11666 = lerp( float2( 0.0, windSquishAmount_g11666 ), float2( windSquishAmount_g11666, 0.0 ), _WindAxisHorizontal );
